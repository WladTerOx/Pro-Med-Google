...
- `2026-08-16T13:10:00Z` — **Restructured summary audit and task indexing**: migrated to explicit hierarchical naming scheme (`med00X` for audits, `med00X.Y` for tasks) across all 8 audit files and 17 task files.
